...
Kernel.fields(['id', 'name', 'uri', 'object_url', 'source', 'created', 'lastModified', 'lastViewed', 'has_children']);
Kernel.url('rest/kernel');
Kernel.has_many('children','VisibleKernelModel','container_object','/rest/kernel/$/children');
