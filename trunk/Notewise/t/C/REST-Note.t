...
is_xml($mech->content,qq#<response><note id="$note3_id" container_object="$kernel_id" created="$created" h="400" lastmodified="$lastmodified" source="myuri" w="300" x="100" y="200"></note>
